...
public class medicalServer {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        medicalServerGUI alert= new medicalServerGUI();
        ...
        while (true) {
            ...
            if (sensorsData != null) {
                ...
                double Temperature = Double.parseDouble(sensorsData[2]);
                ...
                } else if (Temperature >= 38 & Temperature <= 38.9 & HeartRate >= 95 & HeartRate <= 98 & OxygenLevel < 80) {
